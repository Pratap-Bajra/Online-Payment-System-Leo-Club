          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All News Listed Here.....</h3>
                <a href="{{ route('news.create')}}" class="btn btn-sm btn-success" style="float:right">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{ asset('uploads/news/'.$data->image)}}">
                        View</a></td>
                      <td>
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-danger delete-news" data-id="{{ $data->id }}">
